...
class CWPSiteConfigExtension extends DataExtension
{
    ...
    /**
     * Defines whether to use the ColorPaletteField to render theme color picker
     * @var boolean
     */
    ...
    /**
     * Add field for selecting the theme color for different areas of the site. Will create fields
